...
public class Admin {
    ...
    public static int candidatesVotes(String candidate) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(candidate + ".txt"))) {
            br.readLine(); // Skip the first line (manifest)
    ...
    public static int totalVotes() {
        ...
        try (DirectoryStream<Path> stream = Files.newDirectoryStream(dir, "Candidate-*.txt")) {
    ...
    public static void main(String[] args) {
        System.out.println(candidatesVotes("Candidate-1"));
        System.out.println(viewVoter("viswa"));
